...
$userId = isset($_SESSION['customer_id']) ? $_SESSION['customer_id'] : '';
...
<head>
    ...
    <script src="nevbar/nevbar2.css" defer></script>
    ...
    <section class="hero-section">
        ...
        <div class="hero-content">
            ...
            <div class="hero-buttons">
                <a href="category.php?main=Traditional%20Masks" class="primary-btn">Shop Now</a>
                <a href="#artisans" class="secondary-btn">Meet Our Artisans</a>
            </div>
        </div>
                ...
                foreach ($default_categories as $category) {
                    ...
                    <div class="category-card">
                        ...
                        <div class="category-content">
                            ...
                            <a href="<?php echo $category['link']; ?>" class="explore-btn">Explore <i
                ...
                while ($category = $categories_result->fetch_assoc()) {
                    ...
                    <div class="category-card">
                        ...
                        <div class="category-content">
                            ...
                            <a href="category.php?main=<?php echo $category_url; ?>" class="explore-btn">Explore <i
                                    class="fas fa-arrow-right"></i></a>
                        </div>
                    </div>
                    <?php
